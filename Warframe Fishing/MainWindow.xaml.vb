...
Class MainWindow
    ...
    Public Sub New()
        ...
        AllFish.Add(New Fish("Charc Eel", Biomes.Lake, TimeOfDay.Both, Spears.Tulok, Baits.None, New FishSizes(25, 35, 50), New FishSizes(3, 4, 5), New FishSizes(2, 3, 4), New FishSizes(1, 2, 3), "Charc Electroplax"))
        AllFish.Add(New Fish("Mawfish", Biomes.Lake, TimeOfDay.Day, Spears.Tulok, Baits.None, New FishSizes(25, 35, 50), New FishSizes(3, 4, 5), New FishSizes(1, 2, 3), New FishSizes(2, 3, 4), "Mawfish Bones"))
        ...
        AllFish.Add(New Fish("Khut-Khut", Biomes.Landlocked, TimeOfDay.Day, Spears.Peram, Baits.None, New FishSizes(25, 35, 50), New FishSizes(2, 3, 4), New FishSizes(1, 2, 3), New FishSizes(3, 4, 5), "Khut-Khut Venom Sac"))
        ...
        AllFish.Add(New Fish("Cuthol", Biomes.Landlocked, TimeOfDay.Night, Spears.Lanzo, Baits.Cuthol, New FishSizes(500, 650, 1000), New FishSizes(5, 8, 11), New FishSizes(3, 4, 5), New FishSizes(2, 3, 4), "Cuthol Tendrils"))
        AllFish.Add(New Fish("Murkray", Biomes.Coastal, TimeOfDay.Both, Spears.Lanzo, Baits.Murkray, New FishSizes(500, 650, 1000), New FishSizes(1, 3, 5), New FishSizes(2, 4, 6), New FishSizes(7, 8, 9), "Murkray Liver"))
        ...
        AllFish.Add(New Fish("Norg", Biomes.Lake, TimeOfDay.Night, Spears.Peram, Baits.Norg, New FishSizes(500, 650, 1000), New FishSizes(2, 3, 4), New FishSizes(5, 7, 10), New FishSizes(3, 5, 6), "Norg Brain"))
    End Sub
